...
import attr.*;
public class adcompany extends JFrame implements ActionListener
{
	private JButton submit, backButton;
	private JPanel panel;
	private JLabel id, name,contact, street, city,post,state;
        private JTextField ID, nameTF, cnt, streetTF, cty,postTF,stateTF;
		...
		nameTF.setBounds(200, 200, 220, 30);
...
String query3 = "INSERT INTO company (CompanyReg,name, contact, locationID) VALUES ('"+ID.getText()+"','"+nameTF.getText() +"','"+cnt.getText()+"','"+newID+"');";
