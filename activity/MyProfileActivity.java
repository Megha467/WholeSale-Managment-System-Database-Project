...
public class MyProfileActivity extends JFrame implements ActionListener {
	...
	public MyProfileActivity(JFrame activity) {
		super("My Profile");
		...
		buttonEdit.setBounds(60, 330, 160, 30);
		...
		buttonLogout.setBounds(Theme.GUI_WIDTH-180, 40, 160, 30);
		...
		buttonBack.setBounds(Theme.GUI_WIDTH-180, 80, 160, 30);
	...
	/*public MyProfileActivity() {
		...
		buttonLogout = new JButton("Logout");
		buttonLogout.setBounds(Theme.GUI_WIDTH-180, 40, Theme.BUTTON_PRIMARY_WIDTH, 30);
		buttonLogout.setFont(Theme.FONT_BUTTON);
		buttonLogout.setBackground(Color.WHITE);
		buttonLogout.setForeground(Theme.COLOR_TITLE);
		buttonLogout.addActionListener(this);
		...
		buttonBack = new JButton("Back");
		buttonBack.setBounds(Theme.GUI_WIDTH-180, 80, Theme.BUTTON_PRIMARY_WIDTH, 30);
		buttonBack.setFont(Theme.FONT_BUTTON);
		buttonBack.setBackground(Theme.BACKGROUND_BUTTON_PRIMARY);
		buttonBack.setForeground(Theme.COLOR_BUTTON_PRIMARY);
		buttonBack.addActionListener(this);
	...
	*/
	public void actionPerformed(ActionEvent ae) {
		...
		/*else if (ae.getSource().equals(buttonPass)) {
			new ChangePasswordActivity().setVisible(true);*/
		//}//
	}
}